...
void thongtin(Cauthu so[],int&n){
	...
	cout<<"|----------------------------------------------------------------------------------|"<<"\n";
    cout<<"|"<<setw(1)<<"STT|"<<setw(2)<<"Ma CT|";
    cout<<setw(12)<<"Ten CT|";
    cout<<setw(16)<<"Tuoi CT|";
    cout<<setw(14)<<"Vi tri|";
    cout<<setw(16)<<"Huy Chuong|";
    cout<<setw(15)<<"Thuong|";
    cout<<"\n|----------------------------------------------------------------------------------|"<<"\n";
    for (int i=0;i<n;i++)
    {
        ...
        cout<<setw(5)<<so[i].Ten<<setw(6)<<"|";
        cout<<setw(10)<<so[i].tuoi<<setw(6)<<"|";
        cout<<setw(5)<<so[i].Vitri<<setw(14)<<"|";
        cout<<setw(4)<<so[i].huychuong<<setw(5)<<"|";
        cout<<setw(7)<<so[i].thuong<<setw(6)<<"|";
        cout<<"\n|----------------------------------------------------------------------------------|"<<"\n";
    }
    cout<<" "<<endl;
}
